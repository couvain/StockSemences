...
public class TableauFamillePlante extends TableauBase
{
	...
	//
	//--------------------------------------------------------------------------
    public TableauFamillePlante() 
    {
        super(new GridLayout(1,0));
        
        m_table_model = new DefaultTableModel()
        {
			private static final long serialVersionUID = -2843523633559364521L;
	...
	//
	//---------------------------------------------------------------------------
	public int getSelectedFamillePlanteId() 
	{
	...
	public void bd_lance_requete() 
	{
		...
		try 
		{
		    ...
		    ResultSet rs = st.executeQuery("SELECT fap_id, fap_nom FROM famille_plante");
		    while (rs.next())
		    {
