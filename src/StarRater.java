...
{
	private static final long serialVersionUID = 7325026620838533542L;
/** The listener. */
   ...
   *
   * @param stars  The number of stars n.
   * @param d  The rating [0, n]. 0 = no rating.
   * @param selection  The selection [0, n]. 0 = no selection.
   */
  public StarRater(int stars, double d, int selection) 
  {
    this.stars     = stars;
    this.rating    = d;
  ...
  protected void paintComponent(Graphics g) 
  {
    ...
    {     
      ...
      if (rating > i) {
        int dw = (int) ((rating >= (i + 1)) ? w : Math.round((rating - i) * w));
